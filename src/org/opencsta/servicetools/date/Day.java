...
implements Comparable, Cloneable, Serializable {
    ...
    /**
     *  Cria uma nova data
     *  Recebe como parametro uma string que representa uma data no formato Dia-Mes-Ano
     *  O mes pode estar respresentado numericamente ou por extenso
     */
    public Day(String date){

        // no minimo uma data tem de tem tamanho = 8.
        // 2 digitos para dia + 2 digitos para mes + 4 digitos para ano
        if (date.length()>8){
            int dia=-1;
            int mes=-1;
            int ano=-1;
            ...
            dia = Integer.valueOf(date.substring(0, date.indexOf("-"))).intValue();
            mesStr = date.substring(date.indexOf("-")+1, date.lastIndexOf("-"));
            if (mesStr.length()>0)
                mes = converteMesToCalendarConstant(mesStr);
            ano = Integer.valueOf(date.substring(date.lastIndexOf("-")+1, date.length())).intValue();

            initialize(ano, mes, dia);
        }
    }
...
//
//    public String print() {
//        com.managedservicesaustralia.date.DateValidation date = new dateValidation.DateValidation();
//        StringBuffer string = new StringBuffer();
//
//        if (getDayOfMonth() < 10) string.append('0');
//        string.append(getDayOfMonth());
//        string.append("-");
//        string.append(date.converteMesShortToLong(String.valueOf(getMonth()+1)));
//        string.append("-");
//        string.append(getYear());
//        //string.append(" ");
//        //string.append(getDayName());
...
//    }
    ...
    /**
     *  Converte um mes em formato numerico ou extenso para a respectiva
     *  constante da classe Calendar do java.
     *  eg: "janeiro" = Calendar.JANUARY
     *      "01" = Calendar.JANUARY
     */
    public int converteMesToCalendarConstant(String mes){

        if ((mes.length()>0) && (mes.length()==2)){
            if(mes.equalsIgnoreCase("01")) return Calendar.JANUARY;
            else if (mes.equalsIgnoreCase("02")) return Calendar.FEBRUARY;
            else if (mes.equalsIgnoreCase("03")) return Calendar.MARCH;
            else if (mes.equalsIgnoreCase("04")) return Calendar.APRIL;
            else if (mes.equalsIgnoreCase("05")) return Calendar.MAY;
            else if (mes.equalsIgnoreCase("06")) return Calendar.JUNE;
            else if (mes.equalsIgnoreCase("07")) return Calendar.JULY;
            else if (mes.equalsIgnoreCase("08")) return Calendar.AUGUST;
            else if (mes.equalsIgnoreCase("09")) return Calendar.SEPTEMBER;
            else if (mes.equalsIgnoreCase("10")) return Calendar.OCTOBER;
            else if (mes.equalsIgnoreCase("11")) return Calendar.NOVEMBER;
            else if (mes.equalsIgnoreCase("12")) return Calendar.DECEMBER;
            else return -1;
        }
        else if ((mes.length()>0) && (mes.length()>2)){
            int a = Calendar.JANUARY;
            if(mes.equalsIgnoreCase("Janeiro")) return Calendar.JANUARY;
            else if (mes.equalsIgnoreCase("Fevereiro")) return Calendar.FEBRUARY;
            else if (mes.equalsIgnoreCase("Março")) return Calendar.MARCH;
            else if (mes.equalsIgnoreCase("Abril")) return Calendar.APRIL;
            else if (mes.equalsIgnoreCase("Maio")) return Calendar.MAY;
            else if (mes.equalsIgnoreCase("Junho")) return Calendar.JUNE;
            else if (mes.equalsIgnoreCase("Julho")) return Calendar.JULY;
            else if (mes.equalsIgnoreCase("Agosto")) return Calendar.AUGUST;
            else if (mes.equalsIgnoreCase("Setembro")) return Calendar.SEPTEMBER;
            else if (mes.equalsIgnoreCase("Outubro")) return Calendar.OCTOBER;
            else if (mes.equalsIgnoreCase("Novembro")) return Calendar.NOVEMBER;
            else if (mes.equalsIgnoreCase("Dezembro")) return Calendar.DECEMBER;
            else return -1;
        }
        return -1;
    }
...
//    public static String converteData_from_DDMMYYYY_to_YYYYMMDD(String data){
//
//        String dia = new String();
//        String mes = new String();
//        String ano = new String();
//        String dataConvertida = new String();
//        dateValidation.DateValidation validation = new dateValidation.DateValidation();
//
...
//
//        if(mes.length()>2){
//            mes = validation.converteMesLongToShort(mes);
//        }
//
...
//    public static String converteData_from_YYYYMMDD_to_DDMMYYYY(String data){
//
//        String dia = new String();
//        String mes = new String();
//        String ano = new String();
...
//        dateValidation.DateValidation validation = new dateValidation.DateValidation();
//
//        ano = data.substring(0, data.indexOf("-"));
//        mes = data.substring(data.indexOf("-")+1, data.lastIndexOf("-"));
//        dia = data.substring(data.lastIndexOf("-")+1, data.length());
//
//        if(mes.length()==2){
//            mes = validation.converteMesShortToLong(mes);
//        }
//
